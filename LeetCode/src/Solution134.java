...
public class Solution134 {
    public int canCompleteCircuit(int[] gas, int[] cost) {
        /**
         * we take a tour around this circle, the only condition that we can complete this trip is to
         * have more fuel provided than cost in total.
         */
    ...
    public static void main(String[]args){
        Solution134 ns =new Solution134();
        int gas []  = {1,2,3,4,5};
        int cost [] = {3,4,5,1,2};
        System.out.println(ns.canCompleteCircuit(gas,cost));
    }
}
